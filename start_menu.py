        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if self.sound_btn.clicked(x, y):  # check if hit sound btn
                        pygame.mixer.music.unpause()  # continue to play the music

                    if self.mute_btn.clicked(x, y):   # check if mute sound btn
                        pygame.mixer.music.pause()    # stop playing the music
